  ...
  return (
    <main className={s.page}>
      ...
      <section className={s.card} aria-labelledby="local-heading">
        ...
        <p>
          Clone the repository, run <code>npm ci</code>, then configure your MCP
          client with command <code>npm</code>, arguments{" "}
          <code>--silent run mcp</code>, and the repository root as its working
          directory. Transport: <strong>stdio</strong>.
        </p>
        <p>
          The optional skill teaches your agent how to preserve source evidence,
          compare the same pool and interpret refusals. It uses your MCP
          connection and does not install a model.
        </p>
