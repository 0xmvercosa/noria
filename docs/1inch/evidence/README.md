# Public deployment and isolated-fork evidence

The [public Arbitrum deployment record](public-deployment/README.md) records the adapter and factory deployed through Rabby on September 13, 2026, with successful receipts, exact constructor/runtime checks and launch-verifier acceptance. Its [JSON record](public-deployment/deployment.json) preserves addresses, transaction hashes, block references and exact fees. This establishes public contract deployment; Privy financial-flow acceptance, public position/fill execution and aggregator admission require separate evidence. Explorer source publication has not been checked.

## Isolated-fork lifecycle evidence
