...
| Wallet and reserve | Privy embedded creation, funding, exact approval, Aave supply/withdrawal, receipt/report            | Requires public App ID, allowed origins and a real Privy financial-flow acceptance test  |
