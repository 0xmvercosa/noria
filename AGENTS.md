...
- Aave/Aqua execution is demonstrated on isolated local forks. The Privy reserve separately uses an embedded wallet for user-confirmed native-USDC supply/withdrawal on Arbitrum; it never authorizes Aqua public deployment or borrowing. Keep fork evidence distinct from actual Privy wallet actions. Do not claim production deployment, aggregator admission or profitable demand from local related-party fills.
